...
export default function CoursePreview() {
  ...
  const saveChanges = async () => {
    try {
      ...
      setIsEditing(false);
      toast.success("Course updated.", { position: "bottom-right" });
    } catch {
  ...
  const handleOpenCourse = () => {
    const courseSlug = course.title
      ...
      .replace(/\s+/g, "-")
      .replace(/[^a-z0-9-]/g, "");
    const startingModuleNum = course.modules?.[0]?.number || 1;
    navigate(
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              {isEditing ? (
                ...
                <span
                  style={{ backgroundColor: course.levelColor ?? "#2FE12F" }}
