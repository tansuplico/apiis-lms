// src/components/shared/CenterListItem.tsx
import {
  BookOpen,
  Users,
  MoreVertical,
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col sm:flex-row items-stretch border border-gray-200 dark:border-gray-700">
      ...
      <div className="flex-1 p-6 flex flex-col gap-4">
        ...
        <button
          ...
          className="mt-auto w-full sm:w-auto sm:self-start bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white py-3 px-6 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 cursor-pointer"
        >
          Open Center
        </button>
      </div>
