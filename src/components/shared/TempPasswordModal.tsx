// src/components/shared/TempPasswordModal.tsx
...
interface Props {
  tempPassword: string;
  onClose: () => void;
  /** Icon + heading. Defaults match the original facilitator-creation copy. */
  title?: string;
  /** Body copy above the password box. Accepts JSX for bolded names, etc. */
  description?: ReactNode;
  /** Small print below the password box. */
  noteText?: ReactNode;
  buttonLabel?: string;
}
...
export default function TempPasswordModal({
  ...
  noteText = "The facilitator will be required to set a new password on their first login.",
